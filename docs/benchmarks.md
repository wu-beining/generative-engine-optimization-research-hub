...
| [MSME-GEO-Bench / MAGEO](https://huggingface.co/datasets/WuBeiNing/MSME-GEO-Bench) | 2026 | Multi-scenario, multi-engine GEO | query + document + engine setting | Twin Branch attribution, DSV-CF semantic visibility and attribution fidelity | Tests reusable strategy learning across engines/scenarios | New benchmark; needs independent reproduction and comparison against SAGEO/CC-GSEO |
| E-GEO | 2025 | E-commerce GEO | product query + product description/ranking | product visibility and ranking lift under rewriting heuristics | Gives GEO a concrete commerce vertical and code/data path | Needs reproduction; downstream tool claims should be separated from paper evidence |
