...
| [From Experience to Skill: Multi-Agent GEO via Reusable Strategy Learning](https://arxiv.org/abs/2604.19516) | 2026 / ACL Findings | MAGEO，可复用策略学习、Twin Branch Evaluation、DSV-CF、MSME-GEO-Bench | [Wu-beining/MAGEO](https://github.com/Wu-beining/MAGEO), [MSME-GEO-Bench](https://huggingface.co/datasets/WuBeiNing/MSME-GEO-Bench) | core |
...
## 公开 Benchmark / Dataset

| Benchmark | Source | Scope | Public assets | Notes |
| --- | --- | --- | --- | --- |
| GEO-Bench | GEO / KDD 2024 | 通用 GEO visibility benchmark | [GitHub](https://github.com/GEO-optim/GEO), [HF Dataset](https://huggingface.co/datasets/GEO-optim/geo-bench) | 原始基准，但检索/重排抽象较多 |
| C-SEO Bench | NeurIPS D&B 2025 | 对话搜索、多领域、多采用者 | [GitHub](https://github.com/parameterlab/c-seo-bench), [HF Dataset](https://huggingface.co/datasets/parameterlab/c-seo-bench) | 关键负结果基准 |
| AutoGEO datasets | ICLR 2026 | 规则抽取、自动改写、GEO/GEU 评估 | [GitHub](https://github.com/cxcscmu/AutoGEO), [HF Dataset](https://huggingface.co/datasets/cx-cmu/GEO-Bench) | 包含 GEO-Bench derivative、E-commerce、Researchy-GEO 等 |
| CC-GSEO-Bench | 2025 arXiv | source influence / faithful credit / causal impact | [GitHub](https://github.com/qychen2001/CC-GSEO-Bench) | 从曝光推进到影响力评价 |
| MSME-GEO-Bench | MAGEO / ACL Findings 2026 | multi-scenario, multi-engine reusable strategy learning | [GitHub](https://github.com/Wu-beining/MAGEO), [HF Dataset](https://huggingface.co/datasets/WuBeiNing/MSME-GEO-Bench) | MAGEO 官方 benchmark dataset |
| E-GEO | 2025 arXiv | 电商产品查询和推荐式 GEO | [GitHub](https://github.com/psbagga17/E-GEO) | AI shopping / product GEO 重要垂直场景 |
| GEM-Bench | 2025 arXiv | 生成式引擎广告注入 | [GitHub](https://github.com/Generative-Engine-Marketing/GEM-Bench) | adjacent；不要和 organic GEO 混用 |
...
│   ├── benchmarks.csv          # benchmark 和数据集主表
...
GitHub 会读取 [CITATION.cff](CITATION.cff) 并在仓库页面提供 “Cite this repository”。也可以直接使用下面的 BibTeX：

```bibtex
@misc{geoResearchHub2026,
  title = {GEO Research Hub: A Curated Knowledge Base for Generative Engine Optimization},
  author = {{GEO Research Hub contributors}},
  year = {2026},
  url = {https://github.com/Wu-beining/geo-research-hub},
  note = {Maintained research repository}
}
```
